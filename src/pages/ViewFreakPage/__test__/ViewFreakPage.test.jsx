  ...
  useQuery: () => ({
    ...
    data: {
      freak: {
        ...
        photo: { uri: 'https://d30anih4i5atxe.cloudfront.net/uploads/bc2a1f67-7297-4ad4-ba62-d70042ad43cc.png' },
        description: 'I am Marian',
        role: { id: 'frontend', name: 'Frontend' },
        level: { id: 'Novice', name: 'Novice' },
        norm: { id: 'Full time', name: 'Full time' },
        technologies: [ { id: 1, value: 'js', name: 'JS' }, { id: 2, value: 'elm', name: 'Elm' } ],
